...
module Siege::System::DSL
  ...
  module ClassMethods
    ...
    # @api public
    # @since 0.1.0
    def element(element_name, loader: nil, &loader_definition)
      definition_commands << Siege::System::DSL::Commands::Definition::Element.new(
        element_name, loader, loader_definition
      )
    end
  end
end
