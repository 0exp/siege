...
# @api private
# @since 0.1.0
class Siege::System::Instrumentation::Event::Factory
  class << self
    # @option name [String]
    # @option payload [Hash]
    ...
    # @return [Siege::System::Instrumentation::Event]
    #
    # @api private
    # @since 0.1.0
    def create(
      name:,
      payload: Siege::System::Instrumentation::Event::NO_PAYLOAD,
      metadata: Siege::System::Instrumentation::Event::NO_METADATA,
      start_time:,
      end_time:
    )
    ...
    def validate_name(name)
      unless name.is_a?(::String)
        raise(Siege::System::Instrumentation::ArgumentError, <<~ERROR_MESSAGE)
    ...
    def build_event(name, payload, metadata, start_time, end_time)
      Siege::System::Instrumentation::Event.new(
